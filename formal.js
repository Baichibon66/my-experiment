...
const PROLIFIC_COMPLETION_URL = "https://app.prolific.com/submissions/complete?cc=C16PWI5X"; // Completion Code
...
const jsPsych = initJsPsych({
  on_finish: function() {
    ...
    const googleAppsScriptURL = 'https://script.google.com/macros/s/AKfycbyGXPL2UwcJzSqFwGyDMLPmyr8d74eiz6kF6vKFOv1p0AxfHUKBSlCY5vCr66bYkPG8/exec'; // <-- 将此替换为您实际的 URL
...
function startExperiment() {
  ...
  timeline.push({
    ...
    stimulus: `
      <div style='font-size: 28px; text-align: center;'>
        <p>練習が終了しました。スペースキーを押して正式な実験に進んでください。</p>
      </div>
    `,
    choices: [' '],
    css_classes: ['jspsych-content'],
