...
const jsPsych = initJsPsych({
  on_finish: function() {
    ...
    const googleAppsScriptURL = 'https://script.google.com/macros/s/AKfycbzAZ2TzPImVKvajHSB5-uWVZSrnSukr_wT5FGwz4LlruE9OKlwgGbehD0glBFSU7H9t/exec'; // <-- 将此替换为您实际的 URL
